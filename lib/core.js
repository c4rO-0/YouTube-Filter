...
//获取函数
function storageLocalGet(item){
    browserInfo = getBrowserInfo()
    return new Promise((resolve, reject) => {
        if(browserInfo["name"] == "Firefox"){
            browser.storage.local.get(item).then((o) => {
                resolve(o)
            })
        }else if(browserInfo["name"] == "Chrome"){
            chrome.storage.local.get(item,(o) => {
                resolve(o)
            })
        }else{
            resolve(undefined)
...
// 储存函数
// item 是Dictionary类型{key:value}
function storageLocalSet(item){
    browserInfo = getBrowserInfo()
    return new Promise((resolve, reject) => {
        if(browserInfo["name"] == "Firefox"){
            browser.storage.local.set(item).then((o) => {
                resolve(o)
            })
        }else if(browserInfo["name"] == "Chrome"){
            console.log("start to store")
            
            chrome.storage.local.set(item,(o) => {
                resolve(o)
            })
        }else{
            resolve(undefined)
...
//清空函数
function storageLocalClear(item){
    browserInfo = getBrowserInfo()
    return new Promise((resolve, reject) => {
        if(browserInfo["name"] == "Firefox"){
            browser.storage.local.clear(item).then((o) => {
                resolve(o)
            })
        }else if(browserInfo["name"] == "Chrome"){
            console.log("start to store")
            
            chrome.storage.local.clear(item,(o) => {
                resolve(o)
            })
        }else{
            resolve(undefined)
...
function runtimeSendMessage(item){
    browserInfo = getBrowserInfo()
    return new Promise((resolve, reject) => {
        if(browserInfo["name"] == "Firefox"){
            browser.runtime.sendMessage(item).then((o) => {
                resolve(o)
            })
        }else if(browserInfo["name"] == "Chrome"){
            console.log("start to store")
            
            chrome.runtime.sendMessage(item,(o) => {
                resolve(o)
            })
        }else{
            resolve(undefined)
